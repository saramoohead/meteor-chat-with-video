Meteor.js app for rehabilitation charity, designed as a prototype to test whether members of the charity can achieve their personal goals better with the guidance of a mentor and the support of the community.
...
(admin role to delete any comment)
...
(only can delete comments you own)
