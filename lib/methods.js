Meteor.methods({
    addComment: function (commentText, currentChallenge) {
        ...
        var cleanCommentText = UniHTML.purify(commentText);
    ...
    addChallenge: function (challengeDate, challengeTitle, challengeDescription, challengeVideoLink) {
        ...
        var cleanChallengeDescription = UniHTML.purify(challengeDescription);

        Challenges.insert({
            challengeDate: challengeDate,
            challengeTitle: challengeTitle,
            challengeDescription: cleanChallengeDescription,
